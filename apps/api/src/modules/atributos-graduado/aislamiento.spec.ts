/**
 * `atributos-graduado` nunca importa de `plan-estudios` — la dependencia va
 * en un solo sentido (CLAUDE.md §3.1). Mismo mecanismo que las guardias
...
describe('aislamiento de atributos-graduado hacia plan-estudios', () => {
