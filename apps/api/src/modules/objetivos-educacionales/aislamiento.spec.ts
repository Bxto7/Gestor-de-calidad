/**
 * `objetivos-educacionales` nunca importa de `plan-estudios` — la dependencia
 * va en un solo sentido (CLAUDE.md §3.1). Mismo mecanismo que las guardias
 * hermanas: se escribe sobre el especificador ya extraído y lleva su propio
 * control positivo.
 */
...
describe('aislamiento de objetivos-educacionales hacia plan-estudios', () => {
